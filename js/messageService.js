...
// to another object which a key of message and a value of the message being passed to parse. IE data: {message: yourMessage}
...
this.getMessages = function() {
  console.log('getting data for the controller');
    return $http({
        method: 'GET',
        url: 'http://practiceapi.devmounta.in/api/chats'
    }).then(function(response) {
      console.log('Received response and returning to the controller');
